<script>
    const links = [
        ["GitHub", "https://github.com/nickbreaton"]
    ]
</script>

<h1>Nick Breaton</h1>
<p>Front End Engineer working <a href="https://creditkarma.com">Credit Karma</a></p>

<h2>Links</h2>
<ul>
    <li>
        <a href="https://github.com/nickbreaton">GitHub</a>
    </li>
    <li>
        <a href="https://twitter.com/nickbreaton">Twitter</a>
    </li>
    <li>
